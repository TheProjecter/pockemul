...
Cce140p::Cce140p(CPObject *parent):Cce515p(this) {
    ...
    pSIOCONNECTOR = new Cconnector(this,15,0,"Connector 15 pins (Input)",true,QPoint(631,468)); publish(pSIOCONNECTOR);
    pSIOCONNECTOR_OUT = new Cconnector(this,15,1,"Connector 15 pins (Output)",false,QPoint(885,468)); publish(pSIOCONNECTOR_OUT);

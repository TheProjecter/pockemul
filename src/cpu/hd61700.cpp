...
/* HD61700 IRQ vector */
const UINT16 CHD61700::irq_vector[] = {0x0032, 0x0042, 0x0052, 0x0062, 0x0072};
...
inline UINT8 CHD61700::pop(UINT16 &offset)
{
...
inline int CHD61700::check_cond(UINT32 op)
{
    switch ( op & 0x07 )
    {
    case 0x00:	// Z set
...
inline UINT8 CHD61700::make_logic(UINT8 type, UINT8 d1, UINT8 d2)
{
    switch (type&3)
    {
        case 0:	//and
...
inline void CHD61700::check_optional_jr(UINT8 arg)
{
    if (arg & 0x80)
    {
...
inline UINT8 CHD61700::get_sir_im8(UINT8 arg)
{
    if (((arg>>5) & 0x03) == 0x03)
    {
        UINT8 arg1 = read_op();
...
inline UINT8 CHD61700::get_sir_im8(UINT8 arg, UINT8 arg1)
{
    if (((arg>>5) & 0x03) == 0x03)
    {
        return arg1&0x1f;
...
inline int CHD61700::get_sign_mreg(UINT8 arg)
{
...
inline int CHD61700::get_sign_im8(UINT8 arg)
{
    int res = read_op();
...
inline int CHD61700::get_im_7(UINT8 data)
{
    if (data&0x80)
        return 0x80 - data;
    else
...
inline UINT16 CHD61700::make_bcd_sub(UINT8 arg1, UINT8 arg2)
{
...
inline UINT16 CHD61700::make_bcd_add(UINT8 arg1, UINT8 arg2)
{
    UINT32 ret = (arg1&0x0f) + (arg2&0x0f);
    UINT8 carry;

...
typedef void (* funcPtr)(upd7810_state *);
struct opcode_s {
    funcPtr opfunc;
    UINT8 oplen;
    UINT8 cycles;
...
class Cupd7810 : public CCPU
{
public:


    Cupd7810(CPObject *parent);
    virtual ~Cupd7810();
    ...
    static void execute(upd7810_state *cpustate);
    ...
    static UINT8 read_port_byte(upd7810_state *cpustate, offs_t port);
    static void write_port_byte(upd7810_state *cpustate, offs_t port, UINT8 data);
};

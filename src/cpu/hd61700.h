...
typedef void   (*hd61700_lcd_control_func)(CHD61700 &device, UINT8 data);
typedef UINT8  (*hd61700_lcd_data_r_func)(CHD61700 &device);
typedef void   (*hd61700_lcd_data_w_func)(CHD61700 &device, UINT8 data);
typedef UINT16 (*hd61700_kb_r_func)(CHD61700 &device);
typedef void   (*hd61700_kb_w_func)(CHD61700 &device, UINT8 matrix);
typedef UINT8  (*hd61700_port_r_func)(CHD61700 &device);
typedef void   (*hd61700_port_w_func)(CHD61700 &device, UINT8 data);

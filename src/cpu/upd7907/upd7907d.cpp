...
/* prefix 48 */
static const struct Cdebug_upd7810::dasm_s dasm48_7810[256] =
{
...
static const struct Cdebug_upd7810::dasm_s dasm48_7807[256] =
{
    {illegal,0	 }, /* 00: 0100 1000 0000 0000                      */
    {SLRC,"A"       }, /* 01: 0100 1000 0000 0001                      */
    {SLRC,"B"       }, /* 02: 0100 1000 0000 0010                      */
...
/* prefix 4C */
static const struct Cdebug_upd7810::dasm_s  dasm4C_7810[256] =
{
...
static const struct Cdebug_upd7810::dasm_s  dasm4C_7807[256] =
{
    {illegal,0	 }, /* 00: 0100 1100 0000 0000                      */
    {illegal,0	 }, /* 01: 0100 1100 0000 0001                      */
    {illegal,0	 }, /* 02: 0100 1100 0000 0010                      */
...
/* prefix 4D */
static const struct Cdebug_upd7810::dasm_s  dasm4D_7810[256] =
{
...
static const struct Cdebug_upd7810::dasm_s  dasm4D_7807[256] =
{
    {illegal,0	 }, /* 00: 0100 1101 0000 0000                      */
    {illegal,0	 }, /* 01: 0100 1101 0000 0001                      */
    {illegal,0	 }, /* 02: 0100 1101 0000 0010                      */
...
/* prefix 60 */
static const struct Cdebug_upd7810::dasm_s  dasm60[256] =
{
...
/* prefix 64 */
static const struct Cdebug_upd7810::dasm_s  dasm64_7810[256] =
{
...
static const struct Cdebug_upd7810::dasm_s  dasm64_7807[256] =
{
    {MVI,"PA,%b"    }, /* 00: 0110 0100 0000 0000 xxxx xxxx            */
    {MVI,"PB,%b"    }, /* 01: 0110 0100 0000 0001 xxxx xxxx            */
    {MVI,"PC,%b"    }, /* 02: 0110 0100 0000 0010 xxxx xxxx            */
...
/* prefix 70 */
static const struct Cdebug_upd7810::dasm_s  dasm70[256] =
{
...
/* prefix 74 */
static const struct Cdebug_upd7810::dasm_s  dasm74[256] =
{
...
/* main opcodes */
static const struct Cdebug_upd7810::dasm_s  dasmXX_7810[256] =
{
    {NOP,0		 }, /* 00: 0000 0000                                */
...
static const struct Cdebug_upd7810::dasm_s  dasmXX_7807[256] =
{
    {NOP,0		 }, /* 00: 0000 0000                                */
    {LDAW,"%a"      }, /* 01: 0000 0001 oooo oooo                      */
    {INX,"SP"       }, /* 02: 0000 0010                                */
...
static const struct Cdebug_upd7810::dasm_s dasm48_7801[256] = {
    /* 0x00 - 0x3F */
...
static const struct Cdebug_upd7810::dasm_s dasm4c_7801[256] = {
    /* 0x00 - 0x3F */
    { IN, 0 },			{ IN, 0 },			{ IN, 0 },			{ IN, 0 },
    { IN, 0 },			{ IN, 0 },			{ IN, 0 },			{ IN, 0 },
    { IN, 0 },			{ IN, 0 },			{ IN, 0 },			{ IN, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm4d_7801[256] = {
    /* 0x00 - 0x3F */
...
static const struct Cdebug_upd7810::dasm_s dasm60_7801[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 }, { illegal, 0 }, { illegal, 0 },
    { illegal, 0 },		{ illegal, 0 }, { illegal, 0 }, { illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm64_7801[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 }, { illegal, 0 }, { illegal, 0 }, { illegal, 0 },
    { illegal, 0 }, { illegal, 0 }, { illegal, 0 }, { illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm70_7801[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 }, { illegal, 0 }, { illegal, 0 }, { illegal, 0 },
    { illegal, 0 }, { illegal, 0 }, { illegal, 0 }, { illegal, 0 },
    { illegal, 0 }, { illegal, 0 }, { illegal, 0 }, { illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm74_7801[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 }, { illegal, 0 }, { illegal, 0 }, { illegal, 0 },
    { illegal, 0 }, { illegal, 0 }, { illegal, 0 }, { illegal, 0 },
    { illegal, 0 }, { illegal, 0 }, { illegal, 0 }, { illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasmXX_7801[256] = {
    /* 0x00 - 0x3F */
...
static const struct Cdebug_upd7810::dasm_s dasm48_78c05[256] = {
    /* 0x00 - 0x3F */
...
static const struct Cdebug_upd7810::dasm_s dasm4c_78c05[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm4d_78c05[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm60_78c05[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm64_78c05[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm70_78c05[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm74_78c05[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasmXX_78c05[256] = {
    /* 0x00 - 0x3F */
    { NOP, 0 },			{ HALT, 0 },		{ INX, "SP" },		{ DCX, "SP" },
    { LXI, "SP,%w" },	{ ANIW, "%a,%b" },	{ illegal, 0 },		{ ANI, "A,%b" },
    { RET, 0 },			{ SIO, 0 },			{ MOV, "A,B" },		{ MOV, "A,C" },
...
static const struct Cdebug_upd7810::dasm_s dasm48_7907[256] = {
    /* 0x00 - 0x3F */
    { SKIT, "F0" },		{ SKIT, "FT" },		{ SKIT, "F1" },		{ illegal, 0 },	/* TODO: PDF doesn't mention SKIT and SK */
    { SKIT, "FS" },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ SK, "CY" },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm4c_7907[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    ...
    { MOV, "A,PA" },	{ MOV, "A,PB" },	{ MOV, "A,PC" },	{ MOV, "A,MK" },
    { MOV, "A,MB" },	{ MOV, "A,MC" },	{ MOV, "A,TM0" },	{ MOV, "A,TM1" },
    { MOV, "A,S" },		{ illegal, 0 },		{ illegal, 0 },		{ MOV,"A,EOM"  },	/* TODO: Figure out what regsiter C9 indicates */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm4d_7907[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    ...
    { MOV, "PA,A" },	{ MOV, "PB,A" },	{ MOV, "PC,A" },	{ MOV, "MK,A" },
    { MOV, "MB,A" },	{ MOV, "MC,A" },	{ MOV, "TM0,A" },	{ MOV, "TM1,A" },
    { MOV, "S,A" },		{ MOV, "TMM,A" },	{ MOV, "SML,A" },	{ MOV,"EOM,A" },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm60_7907[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ ANA, "A,A" },		{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm64_7907[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ ANI, "A,%b" },	{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm70_7907[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasm74_7907[256] = {
    /* 0x00 - 0x3F */
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
    { illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },		{ illegal, 0 },
...
static const struct Cdebug_upd7810::dasm_s dasmXX_7907[256] = {
    /* 0x00 - 0x3F */
    { NOP, 0 },			{ HALT, 0 },		{ INX, "SP" },		{ DCX, "SP" },
    { LXI, "SP,%w" },	{ ANIW, "%a,%b" },	{ illegal, 0 },		{ ANI, "A,%b" },
    { RET, 0 },			{ SIO, 0 },			{ MOV, "A,B" },		{ MOV, "A,C" },
    ...
    { illegal, 0 },		{ INR, "A" },		{ INR, "B" },		{ INR, "C" },
    { CALL, "%w" },		{ ONIW, "%a,%b" },	{ ADI, "A,%b" },	{ ONI, "A,%b" },
    { 0, dasm48_7907 },	{ illegal, 0 },	{ illegal, 0 },		{ illegal, 0 },
    { 0, dasm4c_7907 },	{ 0, dasm4d_7907 },	{ JRE, "%d" },		{ JRE, "%d" },
    ...
    { 0, dasm60_7907 },	{ DAA, 0 },			{ RETI, 0 },		{ CALB, 0 },
    { 0, dasm64_7907 },	{ NEIW, "%a,%b" },	{ SUI, "A,%b" },	{ NEI, "A,%b" },
    { illegal, 0 },		{ MVI, "A,%b" },	{ MVI, "B,%b" },	{ MVI, "C,%b" },
    { MVI, "D,%b" },	{ MVI, "E,%b" },	{ MVI, "H,%b" },	{ MVI, "L,%b" },

    { 0, dasm70_7907 },	{ MVIW, "%a,%b" },	{ SOFTI, 0 },		{ JB, 0 },
    { 0, dasm74_7907 },	{ EQIW, "%a,%b" },	{ SBI, "A,%b" },	{ EQI, "A,%b" },
    { CALF, "%f" },		{ CALF, "%f" },		{ CALF, "%f" },		{ CALF, "%f" },
    { CALF, "%f" },		{ CALF, "%f" },		{ CALF, "%f" },		{ CALF, "%f" },
...
quint16  Cdebug_upd7810::Dasm_upd7810( char *buffer,
                                       quint16 pc,
                                       const struct Cdebug_upd7810::dasm_s *dasmXX,
                                       const quint8 *oprom, const quint8 *opram,
                                       int is_7810 )
{
    int idx = 0;
    ...
    if (0 == t)
    {
        struct Cdebug_upd7810::dasm_s *p_dasm = (struct Cdebug_upd7810::dasm_s *)a;
...
UINT32 Cdebug_upd7810::DisAsm_1(UINT32 oldpc)
{
    ...
    sprintf(prefix,"%s%*s%s",prefix,16-(decal<<1)," ",Buffer);
